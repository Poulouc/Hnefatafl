...
/**
 * @brief randomPlayer choose between ATTACK and DEFENSE to start the game
 * didn't take any value in setting
 * @return PlayerRole ATTACK or DEFENSE
 */
...
/**
 * @brief permit to start correctly the game
 * @param aPlayer is the Player role of the board
 * @param Boardsize  set the size of the board
 * @param aBoard
 */
...
/**
 * @brief loadBoard can load a Board with his necessary value
 * @param aPlayer is the role to set of the Player
 * @param BoardSize is the size to set of the board
 * @param aBoard is the board to set
 */
void loadBoard(PlayerRole &aPlayer, BoardSize &aBoardSize, Cell aBoard[][BOARD_SIZE_MAX]);

/**
 * @brief enregBoard can register a board in a save
 * @param aBoard is the actual board of the game wich be register in a txt file
 * @param BoardSize is the size of the board
 * @param aPlayer is the player who actual play
 */
